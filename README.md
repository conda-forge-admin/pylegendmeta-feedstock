...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pylegendmeta-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pylegendmeta-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pylegendmeta
# for installing globally
pixi global install pylegendmeta
```
...
It is possible to list all of the versions of `pylegendmeta` available on your platform:
...
```
pixi search pylegendmeta --channel conda-forge
```
